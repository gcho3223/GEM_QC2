...
os.makedirs(data_folder+'/IVplot/txt/',exist_ok=True)
plt.savefig(data_folder+'/IVplot/'+file_names[index_to_open].replace('.txt','_IVplot.png'))
plt.close()
...
#np.savetxt(data_folder+'/'+file_names[index_to_open].replace('.txt','_IVplot.txt'),list_to_save, delimiter='\t', fmt='%s')
np.savetxt(data_folder+'/IVplot/txt/'+file_names[index_to_open].replace('.txt','_IVplot.txt'),list_to_save, delimiter='\t', fmt='%s')
