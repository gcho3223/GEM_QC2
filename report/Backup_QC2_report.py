...
"---------------------------------------------------------------------------"
data_folder='QC2_results/data_ME0_foils_20241021'
subfolder='/'
part1_file=''
part1_file='QC2LONG_PART1_ME0-G3-KR-B06-0010_20241021_15-17'
megger_file='QC2FAST_ME0-G3-KR-B06-0010_20241021_15-17'
all_channels_file=''
all_channels_file='QC2_all_channels_monitor_20241023_00-22'
...
with open(data_folder+'/IVplot/txt'+subfolder+part1_file+'_IVplot.txt') as csv_file:
    csv_content = csv.reader(csv_file, delimiter='\t')
